...
// complete picks the right color for the detected terminal color profile.
// Arguments: ANSI (basic 16), ANSI256, TrueColor.
var complete = lipgloss.Complete(colorprofile.Detect(os.Stdout, os.Environ()))
...
var Matcha = Theme{
	...
	Secondary:  complete(lipgloss.Color("7"), lipgloss.Color("240"), lipgloss.Color("240")),
	SubtleText: complete(lipgloss.Color("7"), lipgloss.Color("241"), lipgloss.Color("241")),
	MutedText:  complete(lipgloss.Color("7"), lipgloss.Color("243"), lipgloss.Color("243")),
	DimText:    lipgloss.Color("250"),
	Danger:     complete(lipgloss.Color("1"), lipgloss.Color("196"), lipgloss.Color("196")),
	Warning:    complete(lipgloss.Color("11"), lipgloss.Color("208"), lipgloss.Color("208")),
	Tip:        complete(lipgloss.Color("11"), lipgloss.Color("214"), lipgloss.Color("214")),
...
var Peach = Theme{
	...
	MutedText:  complete(lipgloss.Color("7"), lipgloss.Color("243"), lipgloss.Color("243")),
	DimText:    lipgloss.Color("250"),
	Danger:     complete(lipgloss.Color("1"), lipgloss.Color("#F38BA8"), lipgloss.Color("#F38BA8")),
	Warning:    complete(lipgloss.Color("11"), lipgloss.Color("#F9E2AF"), lipgloss.Color("#F9E2AF")),
	Tip:        complete(lipgloss.Color("11"), lipgloss.Color("#F9E2AF"), lipgloss.Color("#F9E2AF")),
...
var CatppuccinMocha = Theme{
	...
	AccentText: lipgloss.Color("#1E1E2E"),
	Secondary:  complete(lipgloss.Color("7"), lipgloss.Color("#6C7086"), lipgloss.Color("#6C7086")),
	SubtleText: complete(lipgloss.Color("7"), lipgloss.Color("#7F849C"), lipgloss.Color("#7F849C")),
	MutedText:  complete(lipgloss.Color("7"), lipgloss.Color("#9399B2"), lipgloss.Color("#9399B2")),
	DimText:    lipgloss.Color("#BAC2DE"),
	Danger:     complete(lipgloss.Color("1"), lipgloss.Color("#F38BA8"), lipgloss.Color("#F38BA8")),
	Warning:    complete(lipgloss.Color("11"), lipgloss.Color("#FAB387"), lipgloss.Color("#FAB387")),
	Tip:        complete(lipgloss.Color("11"), lipgloss.Color("#F9E2AF"), lipgloss.Color("#F9E2AF")),
